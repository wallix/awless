...
var FetchersDefs = []fetchersDef{
	{
		...
		Fetchers: []fetcher{
			...
			{Api: "ec2", ResourceType: cloud.ImportImageTask, AWSType: "ec2.ImportImageTask", ApiMethod: "DescribeImportImageTasks", Input: "ec2.DescribeImportImageTasksInput{}", Output: "ec2.ImportImageTasksOutput", OutputsExtractor: "ImportImageTasks"},
