...
var PropertiesDefinitions = []property{
	...
	{AwlessLabel: "DesiredStatus", RDFLabel: fmt.Sprintf("%s:desiredStatus", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Family", RDFLabel: fmt.Sprintf("%s:family", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "LaunchType", RDFLabel: fmt.Sprintf("%s:launchType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "StartedBy", RDFLabel: fmt.Sprintf("%s:startedBy", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
