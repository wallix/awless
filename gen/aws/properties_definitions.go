...
var PropertiesDefinitions = []property{
	...
	{AwlessLabel: "FileSystem", RDFLabel: fmt.Sprintf("%s:fileSystem", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "IP", RDFLabel: fmt.Sprintf("%s:IP", rdf.NetNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "NetworkInterface", RDFLabel: fmt.Sprintf("%s:networkInterface", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "PerformanceMode", RDFLabel: fmt.Sprintf("%s:performanceNode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Token", RDFLabel: fmt.Sprintf("%s:token", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
