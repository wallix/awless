...
var awsResourcesDef = map[string]map[string]*propertyTransform{
	...
	cloud.Instance: {
		...
		"Affinity":              {name: "Placement", transform: extractFieldFn("Affinity")},
		"AvailabilityZone":      {name: "Placement", transform: extractFieldFn("AvailabilityZone")},
		"PlacementGroup":        {name: "Placement", transform: extractFieldFn("GroupName")},
		"DedicatedHost":         {name: "Placement", transform: extractFieldFn("HostId")},
		"Architecture":          {name: "Architecture", transform: extractValueFn},
		"Hypervisor":            {name: "Hypervisor", transform: extractValueFn},
		"IamProfile":            {name: "IamInstanceProfile", transform: extractValueFn},
		"Lifecycle":             {name: "InstanceLifecycle", transform: extractValueFn},
		"NetworkInterfaces":     {name: "NetworkInterfaces", transform: extractSliceValues("NetworkInterfaceId")},
		"PublicDns":             {name: "PublicDnsName", transform: extractValueFn},
		"RootDeviceName":        {name: "RootDeviceName", transform: extractValueFn},
		"RootDeviceType":        {name: "RootDeviceType", transform: extractValueFn},
		"SpotInstanceRequestId": {name: "SpotInstanceRequestId", transform: extractValueFn},
	},
	cloud.Vpc: {
		"Name":      {name: "Tags", transform: extractTagFn("Name")},
	...
	//Database
	cloud.Database: {
		"AllocatedStorage":        {name: "AllocatedStorage", transform: extractValueFn},
		"AutoUpgrade":             {name: "AutoMinorVersionUpgrade", transform: extractValueFn},
		"AvailabilityZone":        {name: "AvailabilityZone", transform: extractValueFn},
		"BackupRetentionPeriod":   {name: "BackupRetentionPeriod", transform: extractValueFn},
		"CACertificateIdentifier": {name: "CACertificateIdentifier", transform: extractValueFn},
		"CharacterSetName":        {name: "CharacterSetName", transform: extractValueFn},
		"CopyTagsToSnapshot":      {name: "CopyTagsToSnapshot", transform: extractValueFn},
		"DBClusterIdentifier":     {name: "DBClusterIdentifier", transform: extractValueFn},
		"Arn":                       {name: "DBInstanceArn", transform: extractValueFn},
		"Class":                     {name: "DBInstanceClass", transform: extractValueFn},
		"Status":                    {name: "DBInstanceStatus", transform: extractValueFn},
		"Name":                      {name: "DBName", transform: extractValueFn},
		"DBParameterGroups":         {name: "DBParameterGroups", transform: extractSliceValues("DBParameterGroupName")},
		"DBSecurityGroups":          {name: "DBSecurityGroups", transform: extractSliceValues("DBSecurityGroupName")},
		"DBSubnetGroup":             {name: "DBSubnetGroup", transform: extractFieldFn("DBSubnetGroupName")},
		"Port":                      {name: "DbInstancePort", transform: extractValueFn},
		"DbiResourceId":             {name: "DbiResourceId", transform: extractValueFn},
		"DNS":                       {name: "Endpoint", transform: extractFieldFn("Address")},
		"HostedZoneId":              {name: "Endpoint", transform: extractFieldFn("HostedZoneId")},
		"Engine":                    {name: "Engine", transform: extractValueFn},
		"EngineVersion":             {name: "EngineVersion", transform: extractValueFn},
		"CreateTime":                {name: "InstanceCreateTime", transform: extractValueFn},
		"Iops":                      {name: "Iops", transform: extractValueFn},
		"LatestRestorableTime":      {name: "LatestRestorableTime", transform: extractValueFn},
		"LicenseModel":              {name: "LicenseModel", transform: extractValueFn},
		"Username":                  {name: "MasterUsername", transform: extractValueFn},
		"MonitoringInterval":        {name: "MonitoringInterval", transform: extractValueFn},
		"MonitoringRoleArn":         {name: "MonitoringRoleArn", transform: extractValueFn},
		"MultiAZ":                   {name: "MultiAZ", transform: extractValueFn},
		"OptionGroup":               {name: "OptionGroupMemberships", transform: extractSliceValues("OptionGroupName")},
		"PreferredBackupDate":       {name: "PreferredBackupWindow", transform: extractValueFn},
		"PreferredMaintenanceDate":  {name: "PreferredMaintenanceWindow", transform: extractValueFn},
		"Public":                    {name: "PubliclyAccessible", transform: extractValueFn},
		"SecondaryAvailabilityZone": {name: "SecondaryAvailabilityZone", transform: extractValueFn},
		"Encrypted":                 {name: "StorageEncrypted", transform: extractValueFn},
		"StorageType":               {name: "StorageType", transform: extractValueFn},
