...
func (cmd *UpdateSecuritygroup) ParamsSpec() params.Spec {
	return params.NewSpec(
		params.AllOf(params.Key("id"), params.Key("protocol"), params.OnlyOneOf(params.Key("inbound"), params.Key("outbound")), params.Opt("cidr", "securitygroup"), params.Suggested("portrange")),
		params.Validators{
			"cidr":     params.IsCIDR,
